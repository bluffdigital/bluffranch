...
export default function Header() {
  ...
  <path d="M80 90h20l5-5 5 5h20" fill="none" stroke="#3C2F2F" strokeWidth="2"/>
  <path d="M280 90h20l5-5 5 5h20" fill="none" stroke="#3C2F2F" strokeWidth="2"/>
  <text x="200" y="220" fontFamily="'Cinzel', serif" fontSize="40" fill="#3C2F2F" textAnchor="middle">Bluff Ranch</text>
</svg>
